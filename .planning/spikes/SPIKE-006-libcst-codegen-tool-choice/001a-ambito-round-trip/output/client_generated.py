# @generated by libcst from aio.py — DO NOT EDIT BY HAND.
# To modify, edit aio.py and run `make codegen` (Phase 19).
...
lista el alias para satisfacer mypy strict ``implicit_reexport=False``::
    ...
    precio = aio.get_dollar_banco_nacion(date)
    aio.aclose()
...
``_client_lock``). Concurrent first-call puede leakear UN ``httpx.Client``
...
class Client:
    ...
    def __reduce__(self) -> Any:  # D-23 — httpx.AsyncClient owns TCP pool + SSL context
        raise TypeError(
            "AmbitoFinancieroClient is not picklable; recreate via Client(...)"
        )

    def __deepcopy__(self, memo: Any) -> Any:  # D-23
        raise TypeError(
            "AmbitoFinancieroClient is not deepcopy-safe (httpx.Client TCP pool)"
        )
...
_default_async_client: Client | None = None
