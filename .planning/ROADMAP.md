...
- [ ] 18-02-PLAN.md — 001a CSTTransformer suite + 3 GO-determining items (1 byte-identical, 4 ruff-check, 6 mocked-suite) + items 2/3/5/7 + item 9 purity; Q1 content-absence instrumented honestly
