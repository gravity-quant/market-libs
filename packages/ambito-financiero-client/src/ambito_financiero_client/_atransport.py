...
Phase 8 RELY-01..04 + D-01/D-04/D-07/D-08/D-19/D-31/D-32. Mirrors the sync
``RetryTransport`` semantics over ``httpx.AsyncHTTPTransport`` using
...
**module** boundary. iol/higyrus/matriz will replicate the same intra-package
import in their own ``_atransport.py``.
"""
...
from ambito_financiero_client._transport import (
    _LOGGER_NAME,
    _RETRY_AFTER_CAP_S,
    _RETRYABLE_EXC,
