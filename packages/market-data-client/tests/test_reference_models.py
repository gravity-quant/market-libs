...
- NONE of the reference models carry a client-stamped ``received_at`` (D-05) —
  ...
  via the INHERITED ``from_api`` (no override), like ``MarketDataEntry``.
"""
